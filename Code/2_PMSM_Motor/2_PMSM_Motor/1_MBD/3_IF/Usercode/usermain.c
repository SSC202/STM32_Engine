...
void usermain(void)
{
    ...
    while (1) {
        ...
        printf("%.2f,%.2f,%.2f,%.2f\r\n", potentiometer_voltage, rtU.I_a, rtU.I_b, rtU.I_c);
        HAL_Delay(1);
    }
}
...
void HAL_ADCEx_InjectedConvCpltCallback(ADC_HandleTypeDef *hadc)
{
    ...
    if (hadc == &hadc1) {
        ...
        if (ADC_offset == 0) {
            ...
            adc1_in3 = hadc1.Instance->JDR2;
            adc1_in2 = hadc2.Instance->JDR1;
            rtU.I_a       = (adc1_in1 - IA_Offset) * 0.02197f;
            rtU.I_b       = (adc1_in2 - IB_Offset) * 0.02197f;
            rtU.I_c       = (adc1_in3 - IC_Offset) * 0.02197f;
            IF_Mode0_step();
