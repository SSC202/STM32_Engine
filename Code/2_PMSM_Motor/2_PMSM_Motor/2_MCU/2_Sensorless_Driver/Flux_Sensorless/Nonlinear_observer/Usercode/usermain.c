...
Nonlinear_Observer_TypeDef non_obs; // 非线性磁链观测器
...
void usermain()
{
    ...
    while (1)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            printf("theta:%.4f,%.4f\r\n", non_obs.theta_true, non_obs.theta_obs);
            break;
        case 3:
            printf("speed:%.4f,%.4f\r\n", non_obs.speed_true, non_obs.speed_obs);
            break;
        case 4:
...
void HAL_ADCEx_InjectedConvCpltCallback(ADC_HandleTypeDef *hadc)
{
    ...
    non_obs.speed_true = encoder.encoder_speed * POLE_PAIRS * encoder.encoder_direct;
    non_obs.theta_true = encoder.electric_theta;
    non_obs.u.alpha = u_alpha_beta.alpha;
    non_obs.u.beta = u_alpha_beta.beta;
    non_obs.i.alpha = i_alpha_beta.alpha;
    non_obs.i.beta = i_alpha_beta.beta;
    Nonlinear_Observer_Update(&non_obs);
