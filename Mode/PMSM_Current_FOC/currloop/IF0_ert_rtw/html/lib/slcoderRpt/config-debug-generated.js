...
dojoConfig.packages.push({'name': 'appcontainer', 'location': '/toolbox/matlab/appcontainer/appcontainer'});
...
dojoConfig.packages.push({'name': 'dependency-shared', 'location': '/toolbox/matlab/dependency/widget/shared/web'});
...
dojoConfig.packages.push({'name': 'filesystem-datamodel', 'location': '/derived/toolbox/matlab/filesystem/datamodel'});
...
dojoConfig.packages.push({'name': 'gbtdivfigure', 'location': '/toolbox/matlab/uitools/divfigurejs'});
dojoConfig.packages.push({'name': 'gbtfigure_uicontainer', 'location': '/toolbox/matlab/uitools/figureuicontainerjs'});
dojoConfig.packages.push({'name': 'gbtshared', 'location': '/toolbox/matlab/uitools/sharedjs'});
dojoConfig.packages.push({'name': 'glee', 'location': '/toolbox/glee/web/glee'});
...
dojoConfig.packages.push({'name': 'liveeditor', 'location': '/toolbox/matlab/codetools/liveeditor/liveeditor'});
...
dojoConfig.packages.push({'name': 'mw-webwindow', 'location': '/ui/mw-webwindow/mw-webwindow'});
dojoConfig.packages.push({'name': 'mw-webwindow-encapsulated', 'location': '/ui/mw-webwindow/mw-webwindow-encapsulated'});
...
dojoConfig.packages.push({'name': 'sf_file_preview_plugin', 'location': '/toolbox/stateflow/sf_file_preview_plugin/js/sf_file_preview_plugin'});
...
dojoConfig.supportedLocales = ['ja-jp','en-us'];
dojoConfig.localeList = 'ja-jp,en-us';
